...
<div class="login-info">
    <span> <!-- User image size is adjusted inside CSS, it should stay as it --> <img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/avatars/sunny.png" alt="me" class="online" /> <a href="javascript:void(0);" id="show-shortcut">john.doe <i class="fa fa-angle-down"></i></a> </span>
</div>
<!-- end user info -->
...
<li>
    <a href="index.html" title="galeria"><i class="fa fa-lg fa-fw fa-eye"></i> <span class="menu-item-parent">GALERÍA</span></a>
</li>

<li>
    <a href="<?php echo Yii::app()->request->baseUrl; ?>/proyecto" title="galeria"><i class="fa fa-lg fa-fw fa-eye"></i> <span class="menu-item-parent">MIS PROYECTOS</span></a>
</li>
...
<li>
    <a href="index.html" title="inversiones"><i class="fa fa-lg fa-fw fa-bar-chart-o"></i> <span class="menu-item-parent">INVERSIONES</span></a>
</li>

<li>
    <a href="index.html" title="inversiones"><i class="fa fa-lg fa-fw fa-group"></i> <span class="menu-item-parent">GRUPO</span></a>
</li>

<li>
    <a href="index.html" title="inversiones"><i class="fa fa-lg fa-fw fa-key"></i> <span class="menu-item-parent">CUENTA</span></a>
</li>

<li>
    <a href="index.html" title="inversiones"><i class="fa fa-lg fa-fw fa-user"></i> <span class="menu-item-parent">PERFIL</span></a>
</li>
